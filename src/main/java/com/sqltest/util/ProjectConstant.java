...
public class ProjectConstant {
    ...
    //第三个数据库
    public static final String MODEL_PACKAGE_PERMISSION = MODEL_PACKAGE + ".permission";	//按照数据库名称分目录
    ...
    //第三个数据库
    public static final String MAPPER_PACKAGE_PERMISSION = MAPPER_PACKAGE + ".permission";	////按照数据库名称分目录
    ...
    //第二个扩展接口
    public static final String MAPPER_INTERFACE_REFERENCE_MYSQL = BASE_PACKAGE + ".util.MySqlMapper";	//Mapper插件基础接口的完全限定名
